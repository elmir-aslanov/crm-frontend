...
export function UsersPage() {
  const paymentRows = [
    ["357 AZN", "01 oktyabr 2025"],
    ["357 AZN", "01 noyabr 2025"],
    ["357 AZN", "01 dekabr 2025"],
    ["357 AZN", "01 yanvar 2026"],
  ];
      ...
      <div className="grid gap-6 lg:grid-cols-[320px_1fr]">
        <section className="rounded-xl border border-border bg-card p-5 shadow-card">
          <div className="flex items-center gap-3 border-b border-border pb-4">
            ...
            <div>
              <h1 className="font-display text-lg font-bold">Oqtay Məmmədzadə</h1>
          ...
          <dl className="mt-4 space-y-3 text-sm">
            <div className="flex items-center justify-between">
              ...
              <dd className="font-medium">070 775 75 99</dd>
            </div>
            <div className="flex items-center justify-between">
              <dt className="text-muted-foreground">QR kod</dt>
              <dd className="font-medium">001-155-023</dd>
            </div>
            <div className="flex items-center justify-between">
              <dt className="text-muted-foreground">Status</dt>
              <dd className="rounded-full bg-course-green/10 px-2 py-0.5 text-xs font-semibold text-course-green">Aktiv</dd>
            </div>
          </dl>
        </section>
        ...
        <section className="rounded-xl border border-border bg-card p-5 shadow-card">
          <div className="mb-4 flex items-center justify-between">
            <h2 className="font-display text-xl font-bold">Ödəniş planı</h2>
            <Button size="sm" variant="outline">Yenilə</Button>
          </div>
            ...
            <table className="w-full text-sm">
              <thead className="border-b border-border text-xs uppercase text-muted-foreground">
                <tr>
                  ...
                  <th className="px-3 py-2 text-left">Ödəniş tarixi</th>
                </tr>
              </thead>
