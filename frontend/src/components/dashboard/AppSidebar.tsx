...
const mainItems = [
  { title: "Ana səhifə", url: "/dashboard", icon: Home },
...
const secondaryItems = [
  ...
  { title: "Kateqoriyalar", url: "/kateqoriyalar", icon: LayoutGrid },
...
export function AppSidebar() {
  ...
  const handleLogout = () => {
    // Sənin proyektdə token hansı adla saxlanılıbsa, hamısını təhlükəsiz silirik
          ...
          <div className="flex items-center gap-3">
            ...
            {!collapsed && (
              <div className="min-w-0">
                <p className="font-display text-base font-bold text-sidebar-foreground truncate">
                  Kometa
                </p>
            ...
            <SidebarMenuItem>
              <SidebarMenuButton asChild className="h-10 rounded-lg">
                <button
                  ...
                  className="flex w-full items-center gap-3 px-3 text-sidebar-foreground/70 hover:bg-red-500/10 hover:text-red-500 transition-colors"
                >
