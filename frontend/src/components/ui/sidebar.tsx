...
>(
  (
    ...
    // We add a state so that we can use it in our wrapper component.
      ...
      >
        ...
        <div
          className={cn(
            ...
            variant === "floating" || variant === "inset"
              ? "p-2 group-data-[collapsible=icon]:w-[calc(var(--sidebar-width-icon)_+_var(--sidebar-gap)_+_2px)]"
  ...
  return (
    <button
      ...
      className={cn(
        ...
        "[[data-collapsible=offcanvas]_&]:left-auto",
        "[[data-collapsible=offcanvas]_&]:hover:bg-sidebar",
        "group-data-[collapsible=offcanvas]:w-8",
        className
      )}
      {...props}
    />
  ...
  return (
    <main
      ...
      className={cn(
        ...
        "peer-data-[variant=inset]:min-h-[calc(100svh-rem)] peer-data-[variant=inset]:m-2 peer-data-[variant=inset]:ml-0 peer-data-[variant=inset]:rounded-xl peer-data-[variant=inset]:shadow md:peer-data-[variant=inset]:ml-0",
        className
      )}
      {...props}
    />
